...
description: 'Phase 5-6: Plan and task breakdown with product-spec cross-validation,
  followed by implementation. Ensures plan and tasks align with product-spec goals
  before executing. Wraps SpecKit plan + tasks + implement with Product Forge traceability
  checks. Use with: "implement feature", "start implementation", "/speckit.product-forge.implement"'
